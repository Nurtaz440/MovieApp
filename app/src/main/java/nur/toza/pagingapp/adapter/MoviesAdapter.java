package nur.toza.pagingapp.adapter;
...
import nur.toza.pagingapp.databinding.SingleMovieItemBinding;
...
public class MoviesAdapter extends PagingDataAdapter<Movie,MoviesAdapter.MovieViewHolder> {
    ...
    public void onBindViewHolder(@NonNull MovieViewHolder holder, int position) {
        ...
        if (currentMovie != null){
            ...
            holder.movieItemBinding.textViewRating.setText(String.valueOf(currentMovie.getVoteAvaerage()));
        }
    }
